<?php
$selectboxParent = Helper::createSelectBox("form[parent_id]","selected_box",$this->slbParent,isset($this->dataForm["parent_id"]) ? $this->dataForm["parent_id"] : "");
                        ...
                        <form role="form" action="#" method="post">
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" placeholder="Nhập tên" name="form[name]" value="<?php if(isset($this->dataForm['name'])) echo $this->dataForm['name'];?>">
                                ...
                                <div class="form-group">
                                    <label>Chủng Loại *</label><br/>
                                    <?php echo $selectboxParent; ?>
                                    <span class="help-block"><?php echo isset($this->errors["parent_id"]) ? $this->errors["parent_id"] : "" ;?></span>
                                </div>
                            </div>
